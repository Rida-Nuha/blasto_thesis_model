"""
Inception (V2-style via Inception v3) with MC Dropout for Uncertainty Estimation
...
# ============================================================
# INCEPTION (V2-STYLE / V3) WITH MC DROPOUT
# ============================================================
class InceptionWithUncertainty(nn.Module):
...
def train_single_model(seed, model_idx, train_loader, val_loader, class_weights):
    ...
    set_seed(seed)
    model = InceptionWithUncertainty(NUM_CLASSES, DROPOUT_RATE).to(DEVICE)
