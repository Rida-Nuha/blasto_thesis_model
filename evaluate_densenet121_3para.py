"""
Multi-Task DenseNet121 Baseline Evaluation Script
Standard Categorical Outputs with MC Dropout Uncertainty Analysis
Internal Medical CNN Baseline for Thesis Comparison
"""
...
# 🚨 Points to the new DenseNet121 saved model
MODEL_PATH = "/kaggle/working/saved_models/densenet121_champion_baseline/densenet121_multitask_seed42_best.pth"
SAVE_DIR = "/kaggle/working/evaluation_plots_densenet121_baseline"
...
# ============================================================
class MultiTaskDenseNet121WithUncertainty(nn.Module):
...
def plot_uncertainty_boxplots(y_true, y_pred, uncertainties, title, filename):
    ...
    plt.title(f"{title} - Uncertainty Distribution (DenseNet121)")
...
def evaluate_mc_dropout():
    ...
    print("Loading Champion DenseNet121 Baseline Model for Evaluation...")
    model = MultiTaskDenseNet121WithUncertainty(dropout_rate=DROPOUT_RATE).to(DEVICE)
    ...
    print("\n==================================================")
    print("FINAL CLINICAL METRICS (DENSENET121 BASELINE)")
    print("==================================================")
    print("\nEXPANSION RESULTS:")
    ...
    plot_confusion_matrix(all_exp_true, all_exp_pred, ['1', '2', '3', '4', '5'], 'DenseNet121 Baseline - Expansion', 'cm_exp_densenet121.png', labels=[1, 2, 3, 4, 5])
    plot_confusion_matrix(all_icm_true, all_icm_pred, ['A', 'B', 'C'], 'DenseNet121 Baseline - ICM', 'cm_icm_densenet121.png', labels=[0, 1, 2])
    plot_confusion_matrix(all_te_true, all_te_pred, ['A', 'B', 'C'], 'DenseNet121 Baseline - TE', 'cm_te_densenet121.png', labels=[0, 1, 2])
    
    plot_uncertainty_boxplots(all_exp_true, all_exp_pred, all_exp_ent, 'Expansion', 'uncertainty_exp_densenet121.png')
    plot_uncertainty_boxplots(all_icm_true, all_icm_pred, all_icm_ent, 'ICM', 'uncertainty_icm_densenet121.png')
    plot_uncertainty_boxplots(all_te_true, all_te_pred, all_te_ent, 'TE', 'uncertainty_te_densenet121.png')
