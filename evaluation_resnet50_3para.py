"""
Multi-Task ResNet50 Baseline Evaluation Script
Standard Categorical Outputs with MC Dropout Uncertainty Analysis
Internal CNN Baseline for Thesis Comparison
"""
...
# 🚨 Points to the new ResNet50 saved model
MODEL_PATH = "/kaggle/working/saved_models/resnet50_champion_baseline/resnet50_multitask_seed42_best.pth"
SAVE_DIR = "/kaggle/working/evaluation_plots_resnet50_baseline"
...
DROPOUT_RATE = 0.3  
BATCH_SIZE = 1  
MC_PASSES = 50  # Locked at 50 to match the Swin-T rigorous baseline
...
# ============================================================
class MultiTaskResNet50WithUncertainty(nn.Module):
...
def plot_uncertainty_boxplots(y_true, y_pred, uncertainties, title, filename):
    ...
    plt.title(f"{title} - Uncertainty Distribution (ResNet50)")
...
def evaluate_mc_dropout():
    ...
    print("Loading Champion ResNet50 Baseline Model for Evaluation...")
    model = MultiTaskResNet50WithUncertainty(dropout_rate=DROPOUT_RATE).to(DEVICE)
    ...
    print("\n==================================================")
    print("FINAL CLINICAL METRICS (RESNET50 BASELINE)")
    print("==================================================")
    print("\nEXPANSION RESULTS:")
    ...
    plot_confusion_matrix(all_exp_true, all_exp_pred, ['1', '2', '3', '4', '5'], 'ResNet50 Baseline - Expansion', 'cm_exp_resnet50.png', labels=[1, 2, 3, 4, 5])
    plot_confusion_matrix(all_icm_true, all_icm_pred, ['A', 'B', 'C'], 'ResNet50 Baseline - ICM', 'cm_icm_resnet50.png', labels=[0, 1, 2])
    plot_confusion_matrix(all_te_true, all_te_pred, ['A', 'B', 'C'], 'ResNet50 Baseline - TE', 'cm_te_resnet50.png', labels=[0, 1, 2])
    
    plot_uncertainty_boxplots(all_exp_true, all_exp_pred, all_exp_ent, 'Expansion', 'uncertainty_exp_resnet50.png')
    plot_uncertainty_boxplots(all_icm_true, all_icm_pred, all_icm_ent, 'ICM', 'uncertainty_icm_resnet50.png')
    plot_uncertainty_boxplots(all_te_true, all_te_pred, all_te_ent, 'TE', 'uncertainty_te_resnet50.png')
