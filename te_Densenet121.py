...
TARGET = "TE_silver"
SAVE_DIR = "/kaggle/working/saved_models/uncertainty_TE_densenet"
...
# MODEL — DENSENET121
# ============================================================
class DenseNet121EmbryoClassifier(nn.Module):
...
# ============================================================
# TRANSFORMS (DenseNet uses 224x224)
# ============================================================
...
for seed in SEEDS:
    ...
    model = DenseNet121EmbryoClassifier().to(device)
    ...
    for epoch in range(25):
        ...
        if val_acc > best_val_acc:
            ...
            torch.save(
                model.state_dict(),
                f"{SAVE_DIR}/TE_silver_densenet121_seed{seed}_best.pth"
            )
            counter = 0
...
# ============================================================
print("\n" + "="*70)
print("FINAL TE DENSENET121 RESULTS")
print("="*70)
