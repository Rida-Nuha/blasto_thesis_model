...
ResNet-18 + Deep Ensembles + MC Dropout
...
# MODEL — RESNET 18
# ============================================================
class ResNet18EmbryoClassifier(nn.Module):
    def __init__(self, num_classes=2, dropout=0.4):
        ...
        # Same classifier head as other backbones
...
def train_model(seed):
    ...
    model = ResNet18EmbryoClassifier().to(device)
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        if val_acc > best_acc:
            ...
            torch.save(
                model.state_dict(),
                f"{MODEL_DIR}/ICM_resnet18_seed{seed}_best.pth"
            )
...
# ============================================================
print("\n" + "="*70)
print("FINAL ICM RESNET-18 RESULTS")
print("="*70)
...
# ARCHIVE MODELS
# ============================================================
shutil.make_archive("ICM_resnet18_models", "zip", MODEL_DIR)
print("\n✅ Models archived: ICM_resnet18_models.zip")
